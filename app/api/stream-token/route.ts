...
export async function GET() {
    try {
        ...
        // ============================================
        // SELF-HEALING: Identity Sync + Auto-Follow
        // ============================================

        // 1. Sync user identity to Stream
        try {
        ...
        // 2. Auto-Follow: Ensure timeline follows user feed
        try {
            ...
            // Non-critical - continue even if follow fails
        }
